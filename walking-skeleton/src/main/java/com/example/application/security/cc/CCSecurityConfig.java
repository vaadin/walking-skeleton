package com.example.application.security.cc;
 ...
 * </p>
 * <ul>
 * <li>The application is NOT running in 'dev' profile</li>
 * <li>The application is deployed on Kubernetes platform</li>
 * </ul>
 *
 * <p>
...
class CCSecurityConfig extends IdentityManagementConfiguration {
    ...
    OidcUserService oidcUserService() {
        ...
        userService.setOidcUserMapper(CCSecurityConfig::mapOidcUser);
        return userService;
    }
